...
// Las cinco cosas del catálogo, con su definición tal y como la manda la base.
const COSAS = [
  { titulo: '84 extras que cobran sin coste',
    motivo: 'Se cobran aparte y la comida que llevan no se descuenta. El 24,1 % está por debajo de lo que de verdad cuesta.',
    peores: 'The Urban Kebab 27 de 27 · Scandal 16 de 17 · Meraki Pita 9 de 9',
    definicion: 'Un extra que el cliente paga aparte y que, sumado lo que lleva, sigue valiendo 0 €.',
    boton: 'Ponerles coste' },
  { titulo: '129 platos sin ficha de coste',
    motivo: 'Se venden sin que Folvy sepa lo que cuestan, así que no entran en la cifra de arriba.',
    peores: 'The Urban Kebab está al 64 % · Chivuos al 53 %',
    definicion: 'Un plato de la carta del que Folvy no sabe lo que cuesta: o no tiene ficha, o la tiene sin cerrar.',
    boton: 'Casar o crear la ficha' },
  { titulo: '314 platos sin envase',
    motivo: 'Tienen el envase a cero. El de los que sí lo tienen vale unos 2.702 € de lo vendido.',
    peores: '',
    definicion: 'Un plato cuya ficha tiene el envase a cero, así que su coste está incompleto.',
    boton: 'Poner envase' },
  { titulo: 'Sin objetivo de comida',
    motivo: 'Folvy no puede decirte si el 24,1 % es bueno o malo hasta que le digas a qué apuntas.',
    peores: '',
    definicion: 'La cuenta no tiene un objetivo de comida sobre ventas al que comparar.',
    boton: 'Poner objetivo' },
  { titulo: '23 ingredientes sin precio',
    motivo: 'Todavía no están en ninguna receta, así que hoy no bloquean ningún coste. Ponles precio antes de usarlos.',
    peores: '',
      ...
      <div className="cocina-pagina">
        ...
        <CifrasCocina>
          <CifraCocina titulo="Comida sobre ventas · todas las marcas" valor="24,1" sufijo="%"
            pie="tuyas 18,6 % · de terceros 27,0 % · 72.777 € vendidos · 3 ventas sin marca (31 €) van dentro" />
          <CifraCocina titulo="Ventas con coste conocido" valor="88,2" sufijo="%"
            pie="el 11,8 % restante se vende sin saber lo que cuesta" />
          <CifraCocina titulo="Platos con coste" valor="422" sufijo="de 551" tono="malo"
            pie="129 se venden sin saber lo que cuestan" />
          <CifraCocina titulo="Extras que cobran sin coste" valor="84" sufijo="de 120" tono="malo"
        ...
        <PanelCocina>
          {COSAS.map((c) => (
            <div key={c.titulo}
              ...
              <div className="text-[13.5px] font-semibold text-cocina-tinta">{c.titulo}</div>
              <div className="min-w-0">
                <div className="text-[12.5px] text-cocina-tinta-2 leading-[1.45]">{c.motivo}</div>
                {c.peores && (
                  <div className="text-[12.5px] text-cocina-tinta-2 leading-[1.45] mt-0.5">
                    Las que más: <b className="font-semibold text-cocina-tinta">{c.peores}</b>
                  </div>
                )}
                <div className="text-[11.5px] text-cocina-tinta-3 mt-1">{c.definicion}</div>
              </div>
              <div className="shrink-0"><BotonCocina>{c.boton}</BotonCocina></div>
            </div>
          ))}
        </PanelCocina>
