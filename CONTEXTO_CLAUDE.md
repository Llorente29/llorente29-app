...
**PENDIENTES del módulo Almacén (próximas sesiones):** **② Niveles máx/mín + alertas de reposición** (cae en Existencias; enciende la tarjeta "Bajo mínimo" del Resumen). **③ Teórico vs Real** (consumo teórico ya existe; añadir desviación; enciende tarjeta "Desviación·AvT"; investigar el stock negativo). **Resumen final**: quitar el "Próximamente" de sus 2 tarjetas cuando ② y ③ existan. **Datos sucios sandbox (Folvy Interno, NO deuda):** Mozzarella "Kilogramo=1500g" y Caja Milanesa Haus con formatos Paquete duplicados (revisar al montar módulo de formatos en serio).
