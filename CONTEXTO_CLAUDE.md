...
**Última actualización: 2026-07-01 (CIERRE · noche). STRIPE PRODUCCIÓN LIVE MONTADO (esperando verificación de Stripe) + REPARTO POR LOCAL EN ORDERS + TIENDA ABIERTA AL PÚBLICO + FIX CRÍTICO DE COCINA (pago).** Sesión de puesta en producción del cobro real del Shop + cierre del frente de reparto.
