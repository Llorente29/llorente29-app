# FOODINT — Contexto para Claude (v4)
...
### Fase 4 — Notificaciones push (PARCIAL)
- [x] Notificaciones in-app (campana 🔔 con badge)
- [ ] Push real con Service Worker / VAPID / Edge Function
- [ ] Email automático cuando ocurren eventos (decisión: usar Resend, no llegamos a implementar)
...
**Última actualización:** 2026-05-10 (Sesión maratoniana v4 — BATCH 1, BATCH 2, Cambios de turno completo)
