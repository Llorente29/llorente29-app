...
-- Aplicada: 2026-08-12 por MCP (verificada: ejecutada contra produccion, devuelve datos)
--
...
--
-- PENDIENTE (deuda declarada): engancharlo a system-alert para que avise solo.
--
