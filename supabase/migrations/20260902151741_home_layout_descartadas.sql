...
-- usado el producto es justo quien deja de ver lo que se anade. El cajon va a
-- avisar de las novedades; esta columna guarda las que el usuario ya dijo que
-- NO quiere.
--
...
begin
  ...
  -- Ninguna fila puede quedar en null: el codigo lee esto sin comprobar.
