...
-- cada pedido. Falla la condición 2 de la banda: NO se aplica entre las 12:15
-- y las 23:45 (reloj de la base, Europe/Madrid). Con `lock_timeout` de 3 s: si
-- hay un pedido entrando, la migración falla y se reintenta; no deja cola
-- detrás de ella.
-- ============================================================================
