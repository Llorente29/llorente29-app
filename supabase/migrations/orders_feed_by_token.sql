-- ============================================================================
-- CAPA 3 · Pedidos por token — orders_feed_by_token
-- ----------------------------------------------------------------------------
-- Variante por token de orders_feed para la Estación de Tablet (sin sesión).
-- Autoriza por TOKEN (kds_resolve_device); cuenta + local salen del dispositivo.
-- El SELECT (vivos/notas/padres/hijas/tickets) es IDÉNTICO a orders_feed: solo
-- cambia de dónde vienen v_account_id / v_location_id (del dispositivo, no del
-- guard de sesión). Así la tablet ve los pedidos de SU local.
-- ============================================================================
