...
-- (corrige la 1600, que aborto: el guard esperaba 6 ocurrencias y hay 9.
--  El guard hizo su trabajo: no se aplico nada a medias.)
--
...
-- (unmapped_reason='no_menu_item') y CERO consumo de stock. 32 ventas asi en 7 dias.
