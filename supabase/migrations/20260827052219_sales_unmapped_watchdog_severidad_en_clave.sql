-- Con la ventana de silencio de _queue_system_alert, este vigia calla 20 h.
-- Pero si la cosa EMPEORA el mismo dia (de AVISO a ALTO, o de ALTO a CRITICO)
-- eso si hay que decirlo. La forma de romper el silencio sin tocar el
...
-- sonar. Que es justo lo que se pedia.
...
BEGIN
  ...
  LOOP
    -- Sin carta montada no hay nada que avisar: todo estaria sin casar.
