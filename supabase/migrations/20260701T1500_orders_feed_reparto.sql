-- supabase/migrations/20260701T1500_orders_feed_reparto.sql
--
...
begin
  ...
  with vivos as (
    select s.id, s.external_ref, s.external_tab_ref,
           ...
           s.rider_name, s.rider_phone, s.eta_pickup, s.eta_delivery, s.transport_price,
  ...
  tickets as (
    select v.id as sale_id, v.external_ref, v.external_tab_ref,
           ...
           v.rider_name, v.rider_phone, v.eta_pickup, v.eta_delivery, v.transport_price,
           v.entro_at,
