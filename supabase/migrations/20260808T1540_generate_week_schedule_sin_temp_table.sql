...
-- Fix: CREATE TEMP TABLE no esta permitido en funcion STABLE.
-- La demanda se guarda en jsonb ('YYYY-MM-DD|HH' -> personas necesarias).
...
declare
  ...
  v_found boolean; v_target numeric; v_pass int; v_cambio boolean;
begin
  ...
  -- PASADA 2: acoplar horas sobrantes donde queda demanda sin cubrir
  v_pass := 0;
  loop
