-- supabase/migrations/20260613T2330_kds_board_fix_canal_ventana.sql
-- ============================================================================
-- CAPA 1 del KDS · FIX kds_board — canal por COALESCE + ventana corta
-- ============================================================================
-- (1) CANAL: las ventas traen el canal en external_channel_text ('glovo'/'uber')
--     y channel_id suele venir NULL (sales_channel sin casar). Resolvemos con
--     COALESCE(nombre casado, texto crudo) -> el board siempre muestra canal.
-- (2) VENTANA: los pedidos 'closed' sin servir se retiran del board a las 2 h
--     (antes 12 h, que saturaba con el acumulado del día sin expo).
-- CREATE OR REPLACE: sustituye la kds_board anterior. Solo cambia kds_board;
-- kds_resolve_device se mantiene (no se recrea aquí).
-- ============================================================================
