...
-- Sin el, la tarjeta enseña «96,6 % del dinero» y no puede acompañarlo de una
-- prueba en euros; acompañarlo de un conteo de unidades daba 95,2 %, o sea un
-- numero distinto del que iba delante. Un numero y su prueba tienen que ser el
-- mismo numero.
