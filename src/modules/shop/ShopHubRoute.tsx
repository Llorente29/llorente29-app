...
const S: Record<string, React.CSSProperties> = {
  ...
  heroLogoBox: { display: 'inline-flex', alignItems: 'center', justifyContent: 'center', borderRadius: 16, background: '#fff', padding: '8px 20px', boxShadow: '0 8px 26px rgba(0,0,0,.22)' },
  heroLogoImg: { height: 84, width: 'auto', maxWidth: 360, objectFit: 'contain', display: 'block' },
