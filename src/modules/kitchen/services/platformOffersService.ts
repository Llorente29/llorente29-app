...
export async function approveCampaign(input: ApproveInput): Promise<void> {
  ...
  //    y activarlo.
  // LEER ANTES DE PISAR (bug cazado 05/07 en vivo): el agente pone location_ids y kind
  // en el cupón, pero el draft de la pantalla NO los conoce — persistir el scope del
  // draft y leer el cupón DESPUÉS los borraba justo antes de usarlos (jobs sin local/hint).
