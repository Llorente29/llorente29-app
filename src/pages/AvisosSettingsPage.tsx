...
export default function AvisosSettingsPage() {
  ...
  if (loading) {
    return <Card className="p-6 text-center"><p className="text-sm text-gray-500">Cargando...</p></Card>
  }
  ...
  return (
    <div className="space-y-4 max-w-2xl">
      ...
      <Card className="p-5">
        <p className="text-xs uppercase tracking-wide text-gray-400 mb-3">Personal</p>
        <h3 className="font-semibold text-gray-900 mb-4">Bolsa de horas</h3>
        ...
        <label className="flex items-start gap-3 cursor-pointer">
          <input
            ...
            className="mt-1 w-4 h-4 accent-[#7C1A1A]"
          />
          <div className="flex-1">
            <p className="text-sm font-medium text-gray-900">Mostrar la bolsa de horas a los trabajadores</p>
      ...
      {/* Personal: Fichajes */}
      <Card className="p-5">
        <p className="text-xs uppercase tracking-wide text-gray-400 mb-3">Fichajes</p>
        <h3 className="font-semibold text-gray-900 mb-4">Tolerancia y alertas</h3>

        <div className="space-y-4">
          <div>
            <label className="text-sm font-medium text-gray-900 block mb-1">Tolerancia de redondeo (minutos)</label>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs text-gray-400">(recomendado: 8)</span>
            </div>
          </div>

          <div>
            <label className="text-sm font-medium text-gray-900 block mb-1">Alerta por retraso</label>
            <p className="text-xs text-gray-500 mb-2">
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <span className="text-xs text-gray-500">min</span>
              <span className="text-xs text-gray-400">(recomendado: 15)</span>
            </div>
          </div>

          <div>
            <label className="text-sm font-medium text-gray-900 block mb-1">Alerta por olvido de salida</label>
            <p className="text-xs text-gray-500 mb-2">
      ...
      <Card className="p-5 opacity-60">
        <p className="text-xs uppercase tracking-wide text-gray-400 mb-3">Notificaciones</p>
        <h3 className="font-semibold text-gray-900 mb-2">Push, Email y WhatsApp</h3>
      ...
      <div className="flex items-center justify-between pt-2">
        <p className="text-xs text-gray-400">
          {savedAt
            ? `✓ Guardado a las ${savedAt.toLocaleTimeString('es-ES', { hour: '2-digit', minute: '2-digit', second: '2-digit' })}`
