...
> **Última actualización**: 9 jun 2026 (CIERRE noche — recepción ESPEJO DEL ALBARAN: recibido a ciegas, foto del albarán a la izquierda, formato en una línea con árbol de pack real vía `ensurePackTree`, "→ X al almacén" visible, rojo+motivo si no cuadra. Construido, pendiente validar con varios albaranes).
