...
| Motor de ofertas por plataforma (agente decide + publica + margen real) | **Pleez** (Madrid), Sapaad, Nory | **EN PRODUCCIÓN (04/07): 2 promos reales creadas por la máquina en Glovo. Agente decide cada hora contra pico histórico + robot publica + Uber API en cola** | 🟢 **GOLEA**: Pleez decide a ciegas del coste; Folvy con margen real por plato (escandallo+comisión sobre base rebajada), guardarraíl que excluye platos bajo margen automáticamente, always-on de recuperación, ciclo cerrado |
